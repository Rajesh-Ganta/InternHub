...
export class AddUsersComponent implements OnInit {
  ...
  postData(){
   ...
   .set('Access-Control-Allow-Origin', '*');
    this.http.post("http://192.168.111.86:8000/userdata",{"data":{sid:this.studentId,name:this.studentId,email:this.email,userType:this.userType}},{headers:header}).subscribe((res)=>{
      console.log(res);
    },(err)=>{
      console.log(err);
    },()=>{
